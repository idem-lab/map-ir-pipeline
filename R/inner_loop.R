...
inner_loop <- function(data,
  ...
  browser()
  oos_predictions_l0 <- train_and_predict_zero_level_model(
    train_predict = train_predict,
    model_list = l_zero_model_list
  )
  ...
  oos_covariates <- combine_predictions(oos_predictions_l0)
  ...
  # currently this is just a linear model

  super_learner_oos <- fit_inla(
  ...
  zero_level_in_sample_fits <- fit_model_list(
